...
<section class="h-140 gradient-form" style="background : url(img1/crystals/gl2.jpg);">
                ...
                <form action="controller/login.php" method="POST">
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" name="email" id="form2Example11" class="form-control"
                      placeholder="Enter your name or email or phone no" required/>
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button name="login" class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">Log
                      in</button>
